...
export default function ResearcherProfile({ params }: { params: { slug: string } }) {
    ...
    try {
      if (navigator.share) {
        await navigator.share({
          title: `Perfil de ${researcher.name}`,
          text: `Mira el perfil de investigación de ${researcher.name} en SECCTI`,
  ...
  const handleEmailClick = () => {
    window.location.href = `mailto:${researcher.email}?subject=Contacto desde SECCTI`
  }

...
const investigadores = [
  ...
  },
  {
    ...
    publications: 32,
    slug: "carlos-mendez",
    expertise: ["Machine Learning", "Deep Learning", "Optimización"],
    yearsExperience: 10,
  },
  {
    id: 3,
    ...
    avatar: "/placeholder.svg?height=100&width=100",
    title: "Investigadora en Ciencias Ambientales",
    institution: "Centro de Investigación en Materiales Avanzados",
    location: "Chihuahua, México",
    field: "Ciencias Ambientales",
    projects: 15,
    publications: 38,
    slug: "ana-martinez",
    expertise: ["Cambio Climático", "Ecosistemas Áridos", "Conservación"],
    yearsExperience: 12,
  },
  {
    id: 4,
    ...
    publications: 27,
    slug: "javier-lopez",
    expertise: ["Robótica", "Automatización", "IoT"],
    yearsExperience: 8,
  },
  {
    id: 5,
    ...
    avatar: "/placeholder.svg?height=100&width=100",
    title: "Investigador en Políticas Públicas",
    ...
    publications: 22,
    slug: "luis-hernandez",
    expertise: ["Políticas Públicas", "Desarrollo Social", "Economía"],
    yearsExperience: 14,
  },
  {
    id: 6,
    ...
    avatar: "/placeholder.svg?height=100&width=100",
    title: "Biotecnóloga",
    institution: "Centro de Investigación en Alimentación y Desarrollo",
    location: "Chihuahua, México",
    field: "Biotecnología",
    projects: 9,
    publications: 31,
    slug: "carmen-morales",
    expertise: ["Biotecnología", "Microbiología", "Alimentos"],
    yearsExperience: 11,
  },
]
